                        ...
                        <li style="margin-bottom:13px" class="goods-hover-shows col-lg-3">
                            <a href="descript.html?id=${elm.id}" onclick="nubiabee('trackStructEvent','shop_index_hot','count',1,{})">
                                <div class="nbc-pro-cont">
                                    <div class="figure"><img src="${elm.imgurl[0]}" data-x2="//oss.static.nubia.cn/blockimage/156194721773.png" width="290" height="248">
                            ...
                            <div class="nbc-pro-btn"><a class="btn-info" href="/product/detail/i/840">查看详情</a><a class="btn-sell" href="/buy/redmagicthree/red8gb128gb">立即购买</a></div>
                        </li>
                        `;
            });
